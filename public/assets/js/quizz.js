    ...
    */
    ...
    nextQuestion()
    {
        ...
        if(this.currentQuestion + 1 < this.quizzData.length)
        {
            ...
            quizz_text_resultat.innerHTML = `<h1 style="text-align:center">Résultats</h1><div class="stats">
                        <i class="fas fa-eye"></i>
                        <span style="margin-left: 8px"></span>
                        <span class="process"
                        data-type="validate"
                        data-process="" >
                        <span class="process--validate"
                        style="width: ${parseInt(this.pourcentage_visuel.substr(0, this.pourcentage_visuel.length - 1))}%" > < /span>
                        < /span>
                    </div><div class="stats">
                        ...
                        data-type="validate"
                        data-process="" >
                        <span class="process--other"
                        style="width: ${parseInt(this.pourcentage_auditif.substr(0, this.pourcentage_auditif.length - 1))}%" > < /span>
                        < /span>
                    </div><div class="stats">
                        ...
                        data-type="validate"
                        data-process="" >
                        <span class="process--failed"
                        style="width: ${parseInt(this.pourcentage_kine.substr(0, this.pourcentage_kine.length - 1))}%" > < /span>
                        < /span>
                    </div>`
            ...
            button.href = '/public/pages/dashboard.html'
            button.innerText = 'Retour au dashboard'
